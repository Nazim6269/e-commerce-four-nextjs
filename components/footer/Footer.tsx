      ...
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
            ...
            <div className="mt-6 w-full md:mt-8 lg:mt-0 lg:max-w-lg">
              <div className="space-y-5 rounded-lg bg-gray-50 p-6 dark:bg-gray-700">
                <Link
                  href="#"
                  title=""
                  className="text-base font-medium text-orange-500 underline hover:no-underline "
                >
                  {" "}
                ...
                <form action="#">
                  <div className="items-end space-y-4 sm:flex sm:space-y-0">
                    ...
                    <div>
                      <button
                        type="submit"
                        className="w-full cursor-pointer rounded-lg bg-orange-400 px-5 py-3 text-center text-sm font-medium text-white "
                      >
                        Subscribe
                      </button>
                    </div>
        ...
        <div className="py-6 md:py-8">
          <div className="gap-4 space-y-5 xl:flex xl:items-center xl:justify-between xl:space-y-0">
            <Link aria-label="go to" href="#" title="" className="block">
              <Image
                height={156}
                width={180}
                src="/logo.png"
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              © 2024{" "}
              <Link aria-label="go to" href="#" className="hover:underline">
                NazimUdin
              </Link>
